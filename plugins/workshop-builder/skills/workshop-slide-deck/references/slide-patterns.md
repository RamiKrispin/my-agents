...
existing deck in your workshop).

> **Provenance note.** These patterns were imported from the course they
> originated in. Pattern notes or example labels that cite a lesson (e.g.
> "C2 L1") refer to that reference course — those files are **not** part of
> this plugin or your repo. For workshops, treat the eyebrow text and any
> "Lesson N" labels as **placeholders**: in workshop decks, use the topic
> vocabulary instead — `Topic NN` (or `NN — Topic Title`), `Previous topic`,
> `Here`, `Next topic`. The visual structure (path, accents, layout) is what's
> reusable; the copy is illustrative.
...
<section class="slide active" style="position:relative;overflow:hidden;">
  ...
  <div class="wrap title-wrap">
    <p class="eyebrow">Topic NN — Topic Title</p>
...
<section class="slide">
  <div class="wrap">
    ...
    <div class="path">
      <div class="stop">
        <div class="lbl">Previous · done</div>
