...
### {{NN}} — {{Topic Title}}  ·  status: {{pending | complete}}
- **Introduced:** {{concepts / tools / files}}
- **State after this topic:** {{what attendees have built so far}}

## Promise tracker

| From topic | Forward promise | Fulfilled by | Status |
| ---------- | --------------- | ------------ | ------ |
| 01 | {{"next we'll …"}} | 02 | pending |
